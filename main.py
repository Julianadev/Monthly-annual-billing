...
# Definindo os meses para uma melhor manipulação:
...
# Calculando e exibindo o percentual relativo de cada mês:
cont = 0
for i in faturamento:
    cont += 1
    percentual = ((i / faturamento_total) * 100)
    print(f'O percentual de faturamento de {m[cont - 1]} é: {percentual:.2f} %')